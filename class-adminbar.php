...
if ( ! class_exists( 'JltAdminBar' ) ) {
	...
	class JltAdminBar {
		...
		public function jlt_admin_bar_init() {
			add_action( 'wp_footer', [ $this, 'add_wpadminbar' ] );
		}


        public function add_wpadminbar() {
            ...
            <style>
                ...
                #wpcombar{background:url('<?php echo JLT_ADMINBAR_IMAGES; ?>/wpcombar_bkg.png') #14568a no-repeat 50% 0;border-bottom:1px solid #3285ae;color:#fff;font:12px "Lucida Grande","Lucida Sans Unicode",Tahoma,Verdana;height:27px;left:0;margin:0;position:absolute;top:0;width:100%}
                #wpcombar .menupop a span{background:url('<?php echo JLT_ADMINBAR_IMAGES; ?>/bullet_arrow_down.gif') no-repeat 100% 0;padding-right:1.5em}
		...
		public static function get_instance() {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof JltAdminBar ) ) {
				self::$instance = new JltAdminBar();
